                  ...
                  <form>
                            <div className='d-flex flex-column align-items-center'>
                                ...
                                <div className=" d-flex w-100 my-2">
                                      <input type="checkbox" id='sell' className="ms-2 me-1"/>
                                      <label htmlFor="sell">Sell</label>
                                      <input type="checkbox" id='rent' className="ms-2 me-1 "/>
                                ...
                                <div className='d-flex w-100'>
                                        <input type="checkbox" className="ms-2 me-1 " id="offer" />
                                        <label htmlFor="offer">Offer</label>
                                </div>

                                    <div className='d-flex w-100 my-2 '>
                                          <div d-flex align-items-center> 
                                            <input type="checkbox" className="ms-2 me-1 " name='' value="" id='house' />
                                            <label htmlFor="house">House</label>
                                          </div>
                                          <div d-flex align-items-center>
                                                <input type="checkbox" className="ms-2 me-1 " name='' value="" id='apartment' />
                                              <label htmlFor="apartment">Apartment</label>
                                          </div>
                                          <div d-flex align-items-center>
                                              <input type="checkbox" className="ms-2 me-1 " name='' value="" id='rland' />
                                    ...
                                    <div className='d-flex w-100 my-2'>
                                        <input type="checkbox" className="ms-2 me-1 " id='parking' />
                                        <label htmlFor="parking">Parking spot</label>
                                        <input type="checkbox" className="ms-2 me-1 " id="furnished" />
                                    ...
                                    <div className='d-flex w-100  my-2'>
                                          <div className=' d-flex align-items-center mb-2'>
                                            <input type="number" className='form-control w-50 me-2' id="bedrooms" min="1" max="10" required/>
                                            <label htmlFor="bedrooms">Beds</label>
                                          </div >
                                          <div className=' d-flex align-items-center mb-2'>
                                            <input type="number" className='form-control w-50 me-2' id="bathrooms" min="1" max="10" required/>
                                            <label htmlFor="bathrooms">Baths</label>
                                          </div>
                                    </div>
                                    <div className='d-flex w-100'>
                                            <div className=' d-flex  w-100 '>
                                                <input type="number" className='form-control w-50 me-2' id="regularPrice" min="1" max="10" required/>
                                                <div>
                                            ...
                                            <div className=' d-flex  w-100 '>
                                                <input type="number" className='form-control w-50 me-2 ' id="discountPrice" min="1" max="10" required/>
                                                <div>
                              ...
                              <div className='d-flex w-100 my-2 flex-column'>
                               ...
                               <div className='d-flex flex-column'>
                                  ...
                                  <div className='d-flex mb-2 gap-5'>
                                    <input  className="p-3 border "type="file" id="images" accept="image/*" multiple />
                                    <button className='btn btn-bg-success'>Upload</button>
                                  </div>
